...
import { Bitcoin, Coffee, Book, Users, Coins, Zap, Rocket } from 'lucide-react';
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {[
              ...
              {
                title: "Brew Station",
                description: "Configure all your mining settings in one place with our universal setup wizard. Streamline your mining configuration experience.",
                icon: Coffee,
                color: "amber",
              ...
              {
                title: "Deploy Mining",
                description: "Review your mining configuration and deploy your mining setup. This final step will activate your mining operations and start earning rewards.",
                icon: Rocket,
                color: "teal",
                action: "Deploy Now →",
                route: "/deploy-mining"
