...
export default function TokenEcosystem() {
  // State for access granted animation - keep it always visible to prevent page flashing
        ...
        <AnimatePresence>
          {showAccessGranted && (
            <motion.div 
              ...
              onAnimationComplete={() => {
                // Keep the text always visible - removed timers that hide/show it
                // This prevents the flickering effect on the page
              }}
            >
  ...
  return (
    <MainLayout>
      <div className="container max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-blue-300 to-indigo-400 mb-2">
          Token Ecosystem
        </h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
              ...
              <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 hover:shadow-yellow-500/10 h-full">
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-20 h-20 rounded-full flex-shrink-0 bg-gradient-to-br from-yellow-600 to-amber-600 flex items-center justify-center shadow-lg">
                      <img src="/tera-logo.png" alt="TERA Token" className="w-16 h-16 object-cover" />
                    </div>
              ...
              <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 hover:shadow-green-500/10 h-full">
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-20 h-20 rounded-full flex-shrink-0 bg-gradient-to-br from-green-600 to-teal-600 flex items-center justify-center shadow-lg">
                      <img src="/lady-bean.png" alt="KLOUDBUGS Core Token" className="w-16 h-16 object-cover" />
                    </div>
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-white mb-2">KLOUDBUGS Core Token</h3>
                      <p className="text-gray-300 mb-4">The official governance token for platform supporters</p>
                      <p className="text-gray-400 mb-6">
                        Our flagship token for people who support the platform. It grants governance rights, revenue sharing, and exclusive access to premium features across our ecosystem.
                      </p>
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-black/30 p-4 rounded-lg">
