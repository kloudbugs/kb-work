...
const CafeEntrancePage: React.FC = () => {
  const [_, navigate] = useLocation();

  // Handle enter button click to navigate to the platform with database scanning
  const handleEnterCafe = () => {
    navigate("/cafe-visualization");
  };
      ...
      >
        ...
        >
          <button 
            ...
            className="cafe-entrance-button"
          >
            Enter Cafe
          </button>
        </motion.div>
...
export default CafeEntrancePage;