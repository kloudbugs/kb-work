...
import { History, Clock, Download, Database, Shield, Copy, Key, Check, Server, RefreshCw } from 'lucide-react';
...
export default function Settings() {
  ...
  // Database settings
  const [dbHost, setDbHost] = useState('localhost'); // Default value
  const [dbPort, setDbPort] = useState('5432'); // Default value
  const [dbName, setDbName] = useState('postgres'); // Default value
  const [dbUser, setDbUser] = useState('postgres'); // Default value
  ...
  // Function to handle field copying
  ...
  useEffect(() => {
    const checkDatabaseConnection = async () => {
      if (activeTab === 'database') {
        ...
        try {
          // In a real app, you'd make an API call to check the database connection
          // For now, we'll just assume it's connected since we know we have a PostgreSQL DB
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center mb-4 space-x-2">
                    <div className={`rounded-full w-3 h-3 flex-shrink-0 
                      ${dbConnectionStatus === 'connected' ? 'bg-green-500' : 
                       dbConnectionStatus === 'disconnected' ? 'bg-red-500' : 'bg-amber-500 animate-pulse'}`}
                    ></div>
                    <span className="text-sm">
                      {dbConnectionStatus === 'connected' ? 'Connected to database' : 
                       dbConnectionStatus === 'disconnected' ? 'Disconnected from database' : 'Checking connection...'}
                    </span>
                    ...
                    <Button 
                      ...
                      size="sm" 
                      className="ml-auto"
                      onClick={() => setDbConnectionStatus('checking')}
                    >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="mt-2 flex">
                          <div className="bg-slate-100 dark:bg-slate-800 p-2 px-3 rounded-l-md border border-r-0 border-slate-200 dark:border-slate-700">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="ml-2"
                            onClick={() => copyToClipboard("PostgreSQL", "type")}
                          >
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="ml-2"
                            onClick={() => copyToClipboard(dbHost, "host")}
                          >
                            <Copy className="h-4 w-4" />
                          </Button>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="ml-2"
                            onClick={() => copyToClipboard(dbPort, "port")}
                          >
                            <Copy className="h-4 w-4" />
                          </Button>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="ml-2"
                            onClick={() => copyToClipboard(dbName, "name")}
                          >
                            <Copy className="h-4 w-4" />
                          </Button>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="ml-2"
                            onClick={() => copyToClipboard(dbUser, "user")}
                          >
                            <Copy className="h-4 w-4" />
                          </Button>
                        </div>
                      ...
                      <div>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              toast({
                                ...
                                description: "For security reasons, the password cannot be copied directly. Please contact your administrator if you need this information.",
                                variant: "default",
                              });
                            }}
                          >
                        ...
                        <p className="text-xs text-red-600 mt-2">
                          For security reasons, the database password is not displayed.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950 rounded-md border border-blue-100 dark:border-blue-900">
                    <h4 className="text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">Connection Information</h4>
                    <p className="text-sm text-blue-700 dark:text-blue-400">
                      This database is managed by the KLOUD BUGS Mining Command Center and is used for storing mining statistics, user information, and transaction history.
                    </p>
                  </div>
                </div>
              </div>
