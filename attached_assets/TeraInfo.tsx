      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-4xl mx-auto mb-16">
            <div className="p-8">
              <h3 className="text-xl font-bold mb-4 text-primary">Key Elements of the Legal Case</h3>
              
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold text-lg mb-2">Medical Care Concerns</h4>
                  <p className="text-gray-700">
                    Despite documented chronic health issues and multiple requests for medical assistance, 
                    Tera's symptoms and pain were not adequately addressed. On the day before her passing, 
                    she reported feeling cold, nauseous, and like she was "going to pass out," yet was denied 
                    additional medical attention.
                  </p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-lg mb-2">Final Day Timeline</h4>
                  <p className="text-gray-700">
                    On October 26, 2023, Tera reported severe pain, describing her spine as feeling "like it was on fire." 
                    Despite these serious symptoms, she was sent back to her cell. Hours later, at 5:11 PM, 
                    she was found unresponsive and was subsequently pronounced deceased.
                  </p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-lg mb-2">Communication with Family</h4>
                  <p className="text-gray-700">
                    In the days leading up to her passing, Tera reached out to her six daughters multiple times, 
                    expressing fears about retaliation, reporting pain, and concerns about not receiving proper medical care. 
                    These communications highlight the distress she was experiencing.
                  </p>
                </div>
                
                <div>
                  <h4 className="font-semibold text-lg mb-2">Broader Pattern of Concern</h4>
                  <p className="text-gray-700">
                    Between May and October of 2023, seven people died while in Multnomah County custody, 
                    suggesting potential systemic issues regarding medical care, substance use treatment, 
                    and mental health support for those in custody.
                  </p>
                </div>
              </div>
            </div>
