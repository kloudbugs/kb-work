  ...
  const steps = [
    {
      ...
      title: "Welcome to Satoshi Bean Mining",
    ...
    },
    {
      ...
      title: "Earn Satoshi Beans",
      description: "Mine and collect Satoshi Beans - unique tokens tied to Satoshi's original blockchain work, supporting civil rights initiatives."
    },
    {
