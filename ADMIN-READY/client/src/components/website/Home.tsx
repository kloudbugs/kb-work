          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl font-medium text-blue-100 mb-8 max-w-3xl mx-auto" style={{ textShadow: '0 0 10px rgba(59, 130, 246, 0.3)' }}>
                ...
                Mine Bitcoin more efficiently with our advanced neural networks and intelligent optimization algorithms that mine Satoshi Beans.
              </p>
              ...
              <div className="flex justify-center" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                <Link href="/mining">
